...
HOME=/home/sam; export HOME
HOSTNAME=FILESERVER.myftp.org; export HOSTNAME
LANG=en_US.UTF-8; export LANG
LESSOPEN=\|\|/usr/bin/lesspipe.sh\ %s; export LESSOPEN
LOGNAME=sam; export LOGNAME
...
OLDPWD=/mnt/megapenthes/Development/py_webradio; export OLDPWD
PATH=/home/sam/bin:/home/sam/bin:/usr/lib64/qt-3.3/bin:/usr/lib64/ccache:/usr/local/bin:/usr/bin:/home/sam/bin:/usr/local/sbin:/usr/sbin:/home/sam/bin; export PATH
PWD=/mnt/megapenthes/Development/py_webradio; export PWD
...
SSH_CLIENT=192.168.0.111\ 52977\ 22; export SSH_CLIENT
SSH_CONNECTION=24.196.71.171\ 58819\ 192.168.0.197\ 22; export SSH_CONNECTION
SSH_TTY=/dev/pts/0; export SSH_TTY
TMUX=/tmp/tmux-1000/default,1573,0; export TMUX
TMUX_PANE=%63; export TMUX_PANE
USER=sam; export USER
XDG_RUNTIME_DIR=/run/user/1000; export XDG_RUNTIME_DIR
XDG_SESSION_ID=2; export XDG_SESSION_ID
cd /mnt/megapenthes/Development/py\_webradio || {
	 echo 'Execution directory inaccessible' >&2
	 exit 1
}
${SHELL:-/bin/sh} << 'marcinDELIMITER0e96836f'
python tune.py 101.5 --duration 2.5hr --gameinfo schedule/2017-12-04.d/WIS-at-PSU_06_00PM.json
marcinDELIMITER0e96836f
